...
void Test()
{
    ...
    struct ThrowOnCopy
    {
        ...
        // Assignment of elements of this type is not required
        ThrowOnCopy& operator=(const ThrowOnCopy& rhs) = delete;
        // The address of the countdown counter. If not equal to nullptr, it decreases with each copy.
        // As soon as it is reset to zero, the copy constructor throws an exception
